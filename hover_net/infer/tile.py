...
def _post_process_patches(
    post_proc_func, post_proc_kwargs, patch_info, image_info, overlay_kwargs, out_dir,
):
    ...
    # ###
    # print(out_dir, image_info['name'])
    # os.makedirs(f'{out_dir}/viz', exist_ok=True)
    # post_res = {'src_image': src_image.copy(), 'inst_info_dict': inst_info_dict, 'overlay_kwargs': overlay_kwargs}
    # with open(f"{out_dir}/viz/{image_info['name']}.pkl", 'wb') as f:
    #     pickle.dump(post_res, f)
    # ###
