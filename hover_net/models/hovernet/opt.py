        ...
        "phase_list": [
            {
                "run_info": {
                    ...
                    "net": {
                        ...
                        "pretrained": "/data2/yuxinyi/hover_net/pretrained/ImageNet-ResNet50-Preact_pytorch.tar",
                        # 'pretrained': None,
                    },
                },
            ...
            },
            {
                ...
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
                "batch_size": {"train": 8, "valid": 16,}, # batch size per gpu
                "nr_epochs": 50,
            },
        ],
        # ------------------------------------------------------------------
