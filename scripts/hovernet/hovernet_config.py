...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = f'hovernet_logs/monuseg/prop{prop:.1f}'
        self.train_dir_list = [
            f'hovernet_dataset/monuseg/prop{prop:.1f}/256x256_164x164'
        ]
        
        # # for 10%/20%/50%/100% augmented:
        # num_samples = 512 # for example
        # self.log_dir = f'hovernet_logs/monuseg/prop{prop:.1f}+_syn_{num_samples}'
        # self.train_dir_list = [
        #     f'hovernet_dataset/monuseg/prop{prop:.1f}/256x256_164x164',
        #     f'hovernet_dataset/monuseg/prop{prop:.1f}+_syn_{num_samples}/256x256_164x164'
        # ]

        self.valid_dir_list = [
            f"hovernet_dataset/monuseg/valid/256x256_164x164"
        ]
