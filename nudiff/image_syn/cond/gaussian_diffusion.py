"""
This code started out as a PyTorch port of Ho et al's diffusion src:
...
class GaussianDiffusion:
    """
    Utilities for training and sampling diffusion src.
    ...
    def p_sample_loop(
        ...
        final = None
        gif_interval = 50
        frames_ids = list(range(0, self.num_timesteps, gif_interval)) + [self.num_timesteps - 1]
        frames_ids = frames_ids[::-1]
        frames = []
        n = self.num_timesteps - 1
