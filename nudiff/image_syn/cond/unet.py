...
from nudiff.image_syn.utils.fp16_util import convert_module_to_f16, convert_module_to_f32
from .nn import (
    SiLU,
    checkpoint,
    conv_nd,
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, y=None):
        ...
        if self.num_classes is not None:
            assert y.shape == (x.shape[0], self.num_classes, x.shape[2], x.shape[3]), f'y.shape: {y.shape}, x.shape: {x.shape}, num_classes: {self.num_classes}'
